                ...
                <form action="../../function.php?id=<?php echo $rowFixProduct['maSanPham'] ?>" method="POST">
                  <div class="form-group" style="width:70%">
                    ...
                    <input type="text" name="nameProduct" class="form-control"
                      value="<?php echo $rowFixProduct['tenSanPham'] ?>" required>
                  </div>
                  <div class="form-group" style="width:70%">
                  ...
                  <div class="form-group" style="width:70%">
                    ...
                    <input type="text" name="giaBan" class="form-control" value="<?php echo $rowFixProduct['giaBan'] ?>"
                      required>
                  </div>
                  <div class="form-group" style="width:70%">
                    <label>Mô tả</label>
                    <textarea name="moTa" class="form-control" id="intro" cols="30" rows="5"
                      required><?php echo $rowFixProduct['moTa'] ?></textarea>
                  </div>
                  <div class="form-group" style="width:70%">
                  ...
                  <div class="form-group" style="width:70%">
                    ...
                    <input class="form-control" type="file" name="image" value="<?php echo $rowFixProduct['hinhAnh'] ?>"
                      style="margin-top:5px;" required>
                  </div>
                  <input type="submit" class="btn btn-primary" name="fixProduct" value="Sửa" style="margin-left: 30%;">
                </form>
                <!-- /.card-body -->
              </div>
              <!-- /.card -->
