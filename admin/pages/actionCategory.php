...
if (isset($_GET['id'])) {
  ...
  $sql_getCategory = "SELECT * FROM danhmuc WHERE maDanhMuc=$maDanhMuc LIMIT 1";
  $query_getCategory = mysqli_query($mysqli, $sql_getCategory);
  $row_getCategory = mysqli_fetch_array($query_getCategory);
          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <form action="../../function.php?id=<?php echo $row_getCategory['maDanhMuc'] ?>" method="POST">
                  <div class="form-group" style="width:70%">
                    <label>Tên danh mục</label>
                    <input type="text" name="tenDanhMuc" class="form-control"
                      value="<?php echo $row_getCategory['tenDanhMuc'] ?>" required>
                  </div>
                  <div class="form-group" style="width:70%">
                    <label>Mô tả</label>
                    <input type="text" name="moTa" class="form-control" value="<?php echo $row_getCategory['moTa'] ?>"
                      required>
                  ...
                  <input type="submit" class="btn btn-primary" name="fixCategory" value="Sửa" style="margin-left: 30%;">
                </form>
              </div>
              <!-- /.card -->
            </div>
